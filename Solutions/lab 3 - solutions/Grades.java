 ...
 * Grades.java 
 * 
 * Read in a sequence of grades and compute the average grade, the 
 * number of passing grades (at least 60) and the number of failing grades
 */ 
...
public class Grades {
	...
	public static void main (String[] args) {
		...
		while (grade >= 0) {
			...
			// We can assign the result of the operator to a variable we ignore 
			// This is to make the statement complete
			int ignored = grade < 60 ? numFail++:numPass++;
